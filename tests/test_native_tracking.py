...
class NativeTests(unittest.TestCase):
    ...
    def test_agy_documented_payload_registers_and_stop_stays_open(self):
        ...
        store=native.dagr.run_paths(self.root/'.nova')[0]
    ...
    def test_claude_child_and_end_archive_after_last_participant(self):
        ...
        path=native.dagr.run_paths(self.root/'.nova')[0];data=native.dagr.read(path)
        ...
        self.assertFalse(native.dagr.run_paths(self.root/'.nova'))
