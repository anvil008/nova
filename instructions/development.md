...
- Keep bounded work local. Delegate only when authorized and an independent question or review warrants it. Give helpers separate ownership, relevant guidance, and a concrete handoff; reuse them for follow-ups. The parent owns synthesis, combined verification, and delivery.
