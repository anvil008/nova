...
Follow the model guidance in `docs/models/gpt-6-astra/prompting.md`: conduct focused, fact-grounded investigations, keep instructions lean and stated once, and maintain read-only boundaries.
...
Return the record with command-linked sources where applicable, result, and disposition ([handoff contract](../handoff.md)).
