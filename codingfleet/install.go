...
var globalCodingRoutingBlock = []byte(routingBeginMarker + "\n" +
	...
	"- Executor Agent is the ordinary target-project writer. Research, Planner, Code Review, Debugger, and Coding Evaluation remain read-only. Factory writes only the canonical Swarm Coder technical/domain catalog, generated projections, and installer-owned global harness state; it never edits target-project code.\n" +
