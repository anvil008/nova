...
2. Select independent specialist review lenses justified by the change
3. Reproduce material findings and de-duplicate overlap
4. Assess correctness, regression, security, compatibility, UI, test, and release evidence
5. Return prioritized findings and safe remediation requirements to the Coding Orchestrator
