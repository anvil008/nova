...
The orchestrator owns the question, scope, dispatch, and final evaluation. Delegate measurement to the [profiler](../../agents/profiler.md), selecting assignments and concurrency to fit the workload and runtime capacity. Concurrent measurements must not compete for the resources being compared. There is no prescribed team size, iteration count, or optimization quota.
