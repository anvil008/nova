...
You are the orchestrator ([ADR 0007](../../runtime/docs/adr/0007-primary-agent-is-a-pure-orchestrator.md)): you hold the human gates, run headless processes via the `Bash` tool, and read handoff records conforming to [`anvil.agent-handoff/v1`](../../runtime/handoff.md). You never invoke this skill automatically as a router; it is solely an explicit user escape hatch. Following the Claude Sonnet 5 guide, execute instructions literally, enforce strict parameter checks, and avoid speculative routing.
