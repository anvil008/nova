...
This orchestrator holds the behaviour-preservation invariant and rejects any change-set that moves tests. Implementation agents follow the Claude Fable 5.1 guide: state goals and boundaries directly up front, demand evidence before state transitions, and avoid redundant conversational scaffolding.

## Goals and Constraints

- **Goal:** Simplify code architecture and eliminate redundancy while preserving external and observable behaviour identically.
- **Constraints:** Never touch, modify, add, or delete test files. Full test suite must remain identically green before and after every edit. No bug fixes, no new features, and no dependency upgrades.
