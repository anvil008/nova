...
- **Emit structured handoff**: Return one `anvil.agent-handoff/v1` record ([contract](../runtime/handoff.md)) with branch, PR, changedFiles, tests with command IDs, runtime proof evidence, review passes, result, and disposition.
