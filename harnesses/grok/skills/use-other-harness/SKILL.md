...
Run the target harness's command below in the shell. No hook reports a foreign process back to this session, so capture its exit status and its output explicitly before you report anything about it.
