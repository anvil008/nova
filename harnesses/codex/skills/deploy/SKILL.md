...
Dispatch specialists with Codex's `spawn_agent` and native messaging; use shell execution for commands. Follow `agents/models.json` and [`anvil.agent-handoff/v1`](../../runtime/handoff.md).
