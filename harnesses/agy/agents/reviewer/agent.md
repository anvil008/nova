...
Return one `anvil.agent-handoff/v1` record ([contract](../../runtime/handoff.md)) with the assigned lens and findings envelope in `evidence`, command-linked runtime evidence when applicable, result, and disposition.