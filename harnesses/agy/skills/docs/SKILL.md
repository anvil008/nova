...
This orchestrator coordinates the documentation audit and delegates documentation editing to the documenter agent. Per the Gemini 3.8 Flash guide, place critical constraints first, verify truth against running code, and maintain concise, factual prose.
